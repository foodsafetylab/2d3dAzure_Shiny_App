...
v_manual_1D = fluidRow(
  ...
  box(title = "Powder Sampling Input Parameters", solidHeader = TRUE, status = "primary",
      ...
      fluidRow(
        column(width = 10, 
               splitLayout(
                 numericInput(inputId = "x_lim", label = "Time (h)", value = 10, min = 1),
                 numericInput(inputId = "y_lim", label = "Production Rate (tonne/h)", value = 10, min = 1)
               ), style = "padding-right: 0px;"),
        column(width = 2, 
      ...
      fluidRow(
        column(width = 10, 
               splitLayout(
                 numericInput(inputId = "spread_radius", label = "Contamination proportion, prevalence (%)", value = 1, min = 0)
               ),style = "padding-right: 0px;"),
        column(width = 2, 
