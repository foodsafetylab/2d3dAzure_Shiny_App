...
#1D Scenario ----
observeEvent(input$OneD_Scenario_Recalled, { 
  #Field Size
  updateNumericInput(session,"x_lim_1d",value = 20.0)
  updateNumericInput(session,"y_lim_1d",value = 1.1)
  #updating point
  updateNumericInput(session, "spread_radius_1d", value = 42)
  #contamination level
  updateNumericInput(session,"cont_level_mu_1d", value = -1.779 )
  updateNumericInput(session,"cont_level_sd_1d", value = 0.675 )
  #number of sampling points
  updateNumericInput(session, "n_sp_1d", value = 30)
  #sampling strategy
  updateSelectInput(session, "method_sp_1d", selected = "srs")
  # m
  updateNumericInput(session, "m_1d", value = 0)
  # M
  updateNumericInput(session, "M_1d", value = 0)
  #individual sample mass
  updateNumericInput(session,"m_sp_1d", value = 10 )
  #iteration section
  updateNumericInput(session, "n_seed_1d", value = 10)
  updateNumericInput(session, "n_iter_1d", value = 100)
})
...
observeEvent(input$OneD_Scenario_Reference, { 
  #Field Size
  updateNumericInput(session,"x_lim_1d",value = 20.0)
  updateNumericInput(session,"y_lim_1d",value = 1.1)
  #updating point
  updateNumericInput(session, "spread_radius_1d", value = 1)
  #contamination level
  updateNumericInput(session,"cont_level_mu_1d", value = -2.44 )
  updateNumericInput(session,"cont_level_sd_1d", value = 0.8 )
  #number of sampling points
  updateNumericInput(session, "n_sp_1d", value = 30)
  #sampling strategy
  updateSelectInput(session, "method_sp_1d", selected = "srs")
